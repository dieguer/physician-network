...
#find doctors 
data=fread('~/Documents/health_replication/shared_pp_data_2016.csv', header = T, sep = ',')
...
fwrite(data, file = '~/Documents/health_replication/shared_pp_filtered_2016.csv',row.names = F)
